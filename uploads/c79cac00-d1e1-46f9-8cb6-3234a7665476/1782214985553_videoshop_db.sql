...
--
-- Host: localhost    Database: videoshop
-- ------------------------------------------------------
...
CREATE TABLE `call_sessions` (
  ...
  `status` enum('ACTIVE','ENDED','MISSED','WAITING') DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `consultants` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK6xr8v4vtiqgq3r0i56lyx54d6` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-23  8:25:46
